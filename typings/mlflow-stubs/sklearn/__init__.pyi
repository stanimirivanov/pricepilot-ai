...
from mlflow.utils.autologging_utils import INPUT_EXAMPLE_SAMPLE_ROWS, MlflowAutologgingQueueingClient, _get_new_training_session_class, autologging_integration, disable_autologging, get_autologging_config, get_instance_method_first_arg_value, resolve_input_example_and_signature, safe_patch, update_wrapper_extended
from mlflow.utils.docstring_utils import LOG_MODEL_PARAM_DOCS, format_docstring
from mlflow.utils.environment import _CONDA_ENV_FILE_NAME, _CONSTRAINTS_FILE_NAME, _PYTHON_ENV_FILE_NAME, _PythonEnv, _REQUIREMENTS_FILE_NAME, _mlflow_conda_env, _process_conda_env, _process_pip_requirements, _validate_env_arguments
from mlflow.utils.file_utils import get_total_file_size, write_to
from mlflow.utils.mlflow_tags import MLFLOW_AUTOLOGGING, MLFLOW_DATASET_CONTEXT
from mlflow.utils.model_utils import _add_code_from_conf_to_system_path, _get_flavor_configuration, _validate_and_copy_code_paths, _validate_and_prepare_target_save_path
...
_MODEL_DATA_SUBPATH = ...
def get_default_pip_requirements(include_cloudpickle=...): # -> list[str]:
    """
    Returns:
...
def get_default_conda_env(include_cloudpickle=...): # -> Any | None:
    """
    Returns:
...
def save_model(sk_model, path, conda_env=..., code_paths=..., mlflow_model=..., serialization_format=..., signature: ModelSignature = ..., input_example: ModelInputExample = ..., pip_requirements=..., extra_pip_requirements=..., pyfunc_predict_fn=..., metadata=...): # -> None:
    """
...
@format_docstring(LOG_MODEL_PARAM_DOCS.format(package_name="scikit-learn"))
def log_model(sk_model, artifact_path, conda_env=..., code_paths=..., serialization_format=..., registered_model_name=..., signature: ModelSignature = ..., input_example: ModelInputExample = ..., await_registration_for=..., pip_requirements=..., extra_pip_requirements=..., pyfunc_predict_fn=..., metadata=...): # -> ModelInfo:
    """
...
class _SklearnModelWrapper:
    ...
    def predict(self, data, params: Optional[dict[str, Any]] = ...):
        """
        Args:
...
def load_model(model_uri, dst_path=...): # -> Any | None:
    """
...
class _AutologgingMetricsManager:
    ...
    def should_log_post_training_metrics(self): # -> bool:
        """
    ...
    def disable_log_post_training_metrics(self): # -> LogPostTrainingMetricsDisabledScope:
    ...
    @staticmethod
    def get_run_id_for_model(model): # -> Any | None:
        ...
    
    @staticmethod
    def is_metric_value_loggable(metric_value): # -> bool:
        """
    ...
    @staticmethod
    def gen_name_with_index(name, index): # -> str:
        ...
    
    def register_prediction_input_dataset(self, model, eval_dataset): # -> str:
        """
    ...
    @staticmethod
    def gen_metric_call_command(self_obj, metric_fn, *call_pos_args, **call_kwargs): # -> str:
        """
    ...
    def register_metric_api_call(self, run_id, metric_name, dataset_name, call_command): # -> str:
        """
        This method will do:
    ...
    def get_run_id_and_dataset_name_for_metric_api_call(self, call_pos_args, call_kwargs): # -> tuple[None, None] | tuple[Any, Any]:
        """
    ...
    def log_post_training_metric(self, run_id, key, value): # -> None:
        """
...
def autolog(log_input_examples=..., log_model_signatures=..., log_models=..., log_datasets=..., disable=..., exclusive=..., disable_for_unsupported_versions=..., silent=..., max_tuning_runs=..., log_post_training_metrics=..., serialization_format=..., registered_model_name=..., pos_label=..., extra_tags=...): # -> None:
    """
